...
namespace BankMore.Infrastructure.Data.Repositories
{
	...
	public abstract class WriteRepository<TEntity, TKey> :IWriteRepository<TEntity, TKey>
		where TEntity : class
	{
		...
		protected WriteRepository(DapperContext context, string tableName, string keyColumn = "Id")
		{
